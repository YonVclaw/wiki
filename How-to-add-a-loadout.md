...
In order to add a ACE Arsenal Loadout you can use the [`cScripts_fnc_exportToArsenal`](cScripts_fnc_exportToArsenal) function or copy the loadout manually by exporting the loadout ut from the Arsenal.
